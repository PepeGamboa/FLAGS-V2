  ...
  },
  {
    ...
    writer: {
      ...
      masterwork: {
        title: "Analectas",
        year: "siglo V a.C.",
        genre: "Textos filosóficos",
        summary:
          "Las Analectas son una colección de dichos y enseñanzas atribuidas a Confucio, recopiladas por sus discípulos después de su muerte. La obra es fundamental para comprender la filosofía confuciana, que ha influido profundamente en la cultura y la política china durante más de dos mil años. Las Analectas abordan temas como la moralidad, la ética, el gobierno, la educación y las relaciones sociales. Confucio enfatiza la importancia de la virtud, la rectitud, la benevolencia, la sabiduría y la lealtad. El objetivo principal de su filosofía es cultivar individuos moralmente superiores que puedan contribuir al bienestar de la sociedad. Las Analectas promueven un sistema de valores basado en el respeto a la autoridad, la armonía social y el cumplimiento de los deberes individuales. La obra ha sido estudiada y comentada por generaciones de eruditos y sigue siendo relevante en el mundo contemporáneo como una guía para la vida ética y el liderazgo responsable.",
        extract:
          "\"El Maestro dijo: 'Aprender y practicar constantemente lo aprendido, ¿no es esto placentero? Tener amigos que vienen de lejos, ¿no es esto también placentero? No sentirse resentido cuando otros no te entienden, ¿no es esto propio de un hombre superior?'\"",
        extractSource: "Libro I, 1",
        image: "/placeholder.svg?height=400&width=600",
        themes: ["Filosofía", "Ética", "Moralidad", "Gobierno", "Educación"],
      },
    },
  },
]
